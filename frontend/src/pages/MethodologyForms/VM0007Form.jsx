...
import { 
  ...
  Shield, AlertTriangle, Clock, CheckCircle, Users, Home
} from 'lucide-react';
...
const VM0007Form = () => {
  ...
  const sections = useMemo(() => [
    ...
    { id: 'soil', title: 'F. Soil Organic Carbon', icon: <Droplets className="w-5 h-5"/>, color: primaryColor },
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const requiredFields = [
        ...
        'mapping.referenceRegion', 'cover.landCoverClass'
      ];
      ...
      setFeedbackMessage('VM0007 Blue Carbon form submitted successfully! Your project is now under review.');
        ...
        return (
          <div className="space-y-6">
            <div className="bg-blue-900/20 border border-blue-700/30 rounded-xl p-4 mb-4">
              ...
              <p className="text-blue-400 text-sm">Enter basic project details and VM0007 methodology registration.</p>
            </div>
            ...
            <MemoSelectField 
              label="Activity Type" 
              options={['Restoration', 'Conservation', 'Sustainable harvest', 'Afforestation', 'Reforestation']}
              required
            ...
            <MemoTextArea 
              ...
              placeholder="Describe the project objectives, scope, and VM0007 methodology application..."
            />
          </div>
        );
        ...
        return (
          <div className="space-y-6">
            <div className="bg-blue-900/20 border border-blue-700/30 rounded-xl p-4 mb-4">
              ...
              <p className="text-blue-400 text-sm">Define project boundaries and spatial configuration according to VM0007 requirements.</p>
            </div>
            ...
            <MemoSelectField 
              ...
              options={['National', 'Sub-unit', 'GMW-defined', 'Custom delineation', 'Administrative boundaries']}
              required
          ...
          <div className="space-y-6">
            <div className="bg-blue-900/20 border border-blue-700/30 rounded-xl p-4 mb-4">
              <div className="flex items-center text-blue-300 mb-2">
                ...
                <span className="font-semibold">Land Cover Change / Stratification</span>
              </div>
              <p className="text-blue-400 text-sm">Classify land cover and monitor changes over time.</p>
            </div>
            
            <MemoSelectField 
              label="Land Cover Class" 
              options={['Mangrove', 'Non-Mangrove', 'Mixed vegetation', 'Water body', 'Bare soil', 'Urban']}
              required
              value={formData.cover?.landCoverClass || ''}
              onChange={handleInputChange('cover', 'landCoverClass')}
            />
            <MemoInputField 
              label="Accuracy" 
              type="number" 
              unit="%"
              value={formData.cover?.accuracy || ''}
              onChange={handleInputChange('cover', 'accuracy')}
              placeholder="e.g., 95"
              step="0.1"
            />
            <FileUpload 
              ...
              accept=".pdf,.xlsx,.csv"
              onChange={handleFileUpload('cover', 'validationMatrix')}
              name="validationMatrix"
              uploadedFiles={uploadedFiles}
            />
            <MemoTextArea 
              label="Classification Methodology" 
              value={formData.cover?.methodology || ''}
              onChange={handleInputChange('cover', 'methodology')}
              placeholder="Describe the land cover classification methodology and validation process..."
            />
          </div>
        );
      ...
      case 'vegetation':
        return (
          <div className="space-y-6">
            ...
            />
            <MemoInputField 
              label="Biomass Sampling Date" 
              type="date"
              value={formData.vegetation?.samplingDate || ''}
              onChange={handleInputChange('vegetation', 'samplingDate')}
            />
          </div>
        );
        ...
        return (
          <div className="space-y-6">
            <div className="bg-emerald-900/20 border border-emerald-700/30 rounded-xl p-4 mb-4">
              ...
              <p className="text-emerald-400 text-sm">Review and confirm your submission according to VM0007 methodology requirements.</p>
            </div>
            ...
            <div className="space-y-4">
              <label className="flex items-start space-x-3 p-4 bg-slate-800/40 rounded-xl border border-blue-800/30 hover:border-blue-500/50 transition-colors">
                ...
                <span className="text-blue-200 text-sm">
                  I confirm all data are accurate and comply with VM0007 Blue Carbon MRV & crediting requirements.
                </span>
              </label>
              ...
              <label className="flex items-start space-x-3 p-4 bg-slate-800/40 rounded-xl border border-blue-800/30 hover:border-blue-500/50 transition-colors">
                <input 
                  ...
                  className="mt-1 w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                  required
                  checked={formData.declaration?.methodologyCompliance || false}
                  onChange={(e) => updateFormData('declaration', 'methodologyCompliance', e.target.checked)}
                />
                <span className="text-blue-200 text-sm">
                  I certify that all VM0007 methodology requirements have been followed and documented.
                </span>
              </label>
            </div>
            ...
            <MemoTextArea 
              ...
              placeholder="Any additional information regarding methodology compliance..."
            />
            ...
            <div className="bg-blue-900/20 rounded-xl p-4 border border-blue-700/30">
              ...
              <div className="text-blue-400 text-sm space-y-1">
                ...
                <p>• Land Cover: {formData.cover?.landCoverClass || 'Not specified'}</p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-center flex-1">
              <h1 className="text-2xl font-bold text-white">VM0007 Blue Carbon MRV (v1.0)</h1>
              <p className="text-blue-300">Data Collection & Monitoring Framework</p>
            </div>
